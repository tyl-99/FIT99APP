...
class DetectionAlternateAdapter(private val exerciseList : ArrayList<Equipment>, private val navigator : NavController) :
    RecyclerView.Adapter<DetectionAlternateAdapter.MyViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.detection_row, parent, false)
