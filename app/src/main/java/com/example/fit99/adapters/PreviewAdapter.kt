...
class PreviewAdapter(private val context: Context, private val myList: List<Preview>,private val navigator : NavController) :
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(preview : Preview) {
            ...
            cont.setOnClickListener {
                val bundle  =Bundle()
                bundle.putString("equipmentName",preview.name)
                navigator.navigate(R.id.action_homeFragment_to_equipmentDetailsFragment,bundle)
            }
