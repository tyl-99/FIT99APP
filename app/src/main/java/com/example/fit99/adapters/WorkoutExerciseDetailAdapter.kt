...
class WorkoutExerciseDetailAdapter(private var exerciseList : ArrayList<Exercise>, private val context : Context) :
    RecyclerView.Adapter<WorkoutExerciseDetailAdapter.MyViewHolder>(),
    ...
    init {
        for (exercise in exerciseList) {
            ...
            val workoutExercise = WorkoutExercise(exerciseName = exercise.name)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        var exerciseR = workoutExercisesList.find { it.exerciseName == currentItem.name }

        var index = workoutExercisesList.indexOfFirst { it.exerciseName == currentItem.name }


        holder.btn.setOnClickListener {
            if (exerciseR != null) {
                showDialog(exerciseR!!,currentItem, object: DialogCallback {
                    override fun onDialogResult(exercise: WorkoutExercise) {
                        ...
                        workoutExercisesList[index] = exercise
    ...
    private fun showDialog(exercise:WorkoutExercise,myex : Exercise, callback: DialogCallback,){
        ...
        recommended.text = "Recommended : ${myex.recommended_reps}"
        recommended_sets.text = "Recommended Sets: ${myex.recommended_sets}"
        recommended_interval.text = "Recommended Rest Interval: ${myex.recommended_rest_interval}"
